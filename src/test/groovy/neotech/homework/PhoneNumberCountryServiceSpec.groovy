...
class PhoneNumberCountryServiceSpec extends DatabaseSpecTemplate {
    ...
    def 'test getPhoneNumberCountryData() - should correctly find phone number country'() {
        ...
        '+47 8671 1309'      | ['Norway']
        '+47 0077 8465'      | ['Norway']
        '+45 12 47 21 94'    | ['Denmark']
        '+45 21 60 26 10'    | ['Denmark']
        '+45 67 82 18 91'    | ['Denmark']
        '+45 58 40 96 80'    | ['Denmark']
        '+31 27 32842497'    | ['Netherlands']
        '+31 69 68409193'    | ['Netherlands']
        '+31 96 25223794'    | ['Netherlands']
        '+31 96 87720552'    | ['Netherlands']
        '+32 2735740449'     | ['Belgium']
        '+32 9576107618'     | ['Belgium']
        '+32 7775014029'     | ['Belgium']
        '+32 4630546279'     | ['Belgium']
        '+41 407528836'      | ['Switzerland']
        '+41 676134338'      | ['Switzerland']
        '+41 040309859'      | ['Switzerland']
        '+41 743938189'      | ['Switzerland']
        '+43 (888) 895 400'  | ['Austria']
        '+43 (074) 613 542'  | ['Austria']
        '+43 (885) 611 691'  | ['Austria']
        '+43 (577) 790 214'  | ['Austria']
        '+351 418 848 597'   | ['Portugal']
        '+351 113 477 045'   | ['Portugal']
        '+351 699 225 640'   | ['Portugal']
        '+351 874 442 099'   | ['Portugal']
        '+353 34 094 3812'   | ['Ireland']
        '+353 55 907 2948'   | ['Ireland']
        '+353 46 215 2639'   | ['Ireland']
        '+353 06 029 9980'   | ['Ireland']
        '+64 98 2027 6402'   | ['New Zealand', 'Pitcairn Islands']
        '+64 53 7440 0014'   | ['New Zealand', 'Pitcairn Islands']
        '+64 37 2275 9355'   | ['New Zealand', 'Pitcairn Islands']
        '+64 63 2333 3847'   | ['New Zealand', 'Pitcairn Islands']
        '+358 15 6278 545'   | ['Finland']
        '+358 52 5406 982'   | ['Finland']
        '+358 34 2186 019'   | ['Finland']
        '+358 89 3165 519'   | ['Finland']
        '+65 2995 9602'      | ['Singapore']
        '+65 6494 6290'      | ['Singapore']
        '+65 6889 0952'      | ['Singapore']
        '+65 9613 5492'      | ['Singapore']
        '+852 2991 1016'     | ['Hong Kong']
        '+852 1027 8688'     | ['Hong Kong']
        '+852 4846 0443'     | ['Hong Kong']
        '+852 5092 2236'     | ['Hong Kong']
        '+972 44-9734-7031'  | ['Israel']
        '+972 92-6786-6151'  | ['Israel']
        '+972 46-7233-2433'  | ['Israel']
        '+972 55-1746-4164'  | ['Israel']
        '+420 708 887 302'   | ['Czech Republic']
        '+420 309 187 712'   | ['Czech Republic']
        '+420 112 516 937'   | ['Czech Republic']
        '+420 578 194 621'   | ['Czech Republic']
        '+36 87 410 075'     | ['Hungary']
        '+36 17 264 899'     | ['Hungary']
        '+36 48 508 869'     | ['Hungary']
        '+36 89 686 206'     | ['Hungary']
        '+56 (9) 9342 5745'  | ['Chile', 'Easter Island']
        '+56 (3) 0109 6062'  | ['Chile', 'Easter Island']
        '+56 (3) 7241 8667'  | ['Chile', 'Easter Island']
        '+56 (5) 8539 2794'  | ['Chile', 'Easter Island']
    }
    ...
    def 'test getPhoneNumberCountryData() - should throw error for invalid phone number'() {
        ...
        '+01234567890'                                                   | "Country data for phone: ${invalidPhoneNumber} do not exist"
        '+0491 570 006'                                                  | "Country data for phone: ${invalidPhoneNumber} do not exist"
    }
}
